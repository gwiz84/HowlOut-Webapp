...
try    {
	...
	{
		echo "<div class='blob'>".$blob->getName().": ".$blob->getUrl()."&nbsp;(".$blob->getProperties()->getContentLength()." bytes)&nbsp;<button class='btn-delete' data-blobname='".$blob->getName()."'>Delete</button><br><br></div>";
	}
}
