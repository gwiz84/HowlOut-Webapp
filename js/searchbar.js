    ...
    if (searchTerms.length > 0) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                try {
                    ...
                    $(".searchContent").append('<div style="width: 100%;height:50px;padding:10px;" class="eventHeader"><h5><i class="material-icons icon_purple" style="font-size:28px;vertical-align:middle;">event_note</i>&nbsp;&nbsp;Events</h5></div>');
        ...
        $.ajax({
            ...
            success: function (data) {
                try {
                    var jsonObject = JSON.parse(data);
                    $(".searchContent").append('<div style="width: 100%;height:50px;padding:10px;" class="groupHeader"><h5><i class="material-icons icon_peep" aria-hidden="true" style="font-size:26px;vertical-align:middle;">group</i>&nbsp;&nbsp;Groups</h5></div>');
                    $.each(jsonObject, function (i, ele) {
